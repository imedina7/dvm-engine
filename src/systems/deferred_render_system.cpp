...
void DeferredRenderSystem::createPipeline(VkRenderPass renderPass)
{
...
void DeferredRenderSystem::createDescriptorPool() {
...
void DeferredRenderSystem::createDescriptorSetLayouts() {
  globalSetLayout =
...
void DeferredRenderSystem::render(FrameInfo& frameInfo)
{
...
void DeferredRenderSystem::beginShadowPass(VkCommandBuffer commandBuffer) {

}
void DeferredRenderSystem::endShadowPass(VkCommandBuffer commandBuffer) {

}



void DeferredRenderSystem::update(FrameInfo& frameInfo, GlobalUbo& ubo) {
  ...
  void DeferredRenderSystem::renderShadowMaps(FrameInfo& frameInfo, GlobalUbo& ubo){
