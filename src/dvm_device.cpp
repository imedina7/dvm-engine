...
DvmDevice::DvmDevice(DvmWindow& window)
    : window {window}
{
  createInstance();
  setupDebugMessenger();
...
SwapChainSupportDetails DvmDevice::querySwapChainSupport(
...
VkFormat DvmDevice::findSupportedFormat(const std::vector<VkFormat>& candidates,
...
uint32_t DvmDevice::findMemoryType(uint32_t typeFilter,
...
void DvmDevice::createBuffer(VkDeviceSize size,
...
void DvmDevice::copyBufferToImage(VkBuffer buffer,
                                  VkImage image,
                                  uint32_t width,
                                  uint32_t height,
                                  uint32_t layerCount)
...
void DvmDevice::createImageWithInfo(const VkImageCreateInfo& imageInfo,
                                    VkMemoryPropertyFlags properties,
                                    VkImage& image,
