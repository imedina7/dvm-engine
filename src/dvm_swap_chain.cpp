...
DvmSwapChain::DvmSwapChain(DvmDevice& deviceRef, VkExtent2D extent)
    : device {deviceRef}
    , windowExtent {extent}
{
  init();
...
DvmSwapChain::DvmSwapChain(DvmDevice& deviceRef,
                           VkExtent2D extent,
...
VkResult DvmSwapChain::acquireNextImage(uint32_t* imageIndex)
{
...
VkResult DvmSwapChain::submitCommandBuffers(const VkCommandBuffer* buffers,
                                            uint32_t* imageIndex)
{
...
void DvmSwapChain::createSwapChain()
{
...
void DvmSwapChain::createImageViews()
{
...
void DvmSwapChain::createDepthResources()
{
...
void DvmSwapChain::createSyncObjects()
{
...
VkSurfaceFormatKHR DvmSwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR DvmSwapChain::chooseSwapPresentMode(
...
VkExtent2D DvmSwapChain::chooseSwapExtent(
...
VkFormat DvmSwapChain::findDepthFormat()
{
